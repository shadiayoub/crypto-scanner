...
def main():
    ...
    if not args.no_smc and not SMC_AVAILABLE:
        print("\n⚠️ SMC toolkit not available. Install with: pip install smc-toolkit")
        print("   SMC filters will be disabled.")
        use_smc = False
    else:
    ...
    if not SMC_AVAILABLE and use_smc:
        print("   ⚠️ SMC toolkit not installed. Install with: pip install smc-toolkit")
